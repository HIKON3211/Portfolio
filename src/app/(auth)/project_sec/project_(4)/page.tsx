      ...
      <section className="min-h-screen bg-gray-50 py-20 px-6">
        <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg p-8">
          ...
          <p className="text-gray-600 mb-6 leading-relaxed">
                 ได้ไปแข่งขันศิลปหัตถกรรม หุ่นยนต์ระดับสูง ที่จะต้องเดินผ่านเส้นทางและทำภารกิจโดยที่รอบจริงกับรอบซ้อมนั้นจะใช้คนละสนามกัน
          </p>
          <p className="text-gray-600 mb-6 leading-relaxed">
                                 สิ่งที่ได้รับ : ก่อนเริ่มสมัครก็ได้เริ่มศึกษาเกี่ยวกับภาษา C++ ที่จำเป็นต้องใช้ในการสั่งการโปรแกรม ต่อมาก็เริ่มเขียนในส่วนของชุดคำสั่งเป็นอัลกอริทึม 
