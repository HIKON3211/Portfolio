      ...
      <section className="min-h-screen bg-gray-50 py-20 px-6">
        <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg p-8">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mb-4">
            ได้มีการเรียนทำภาพยนต์สั้นในวิชาภายในโรงเรียน
          </h1>
          <p className="text-gray-600 mb-6 leading-relaxed">
            ได้รับหน้าที่เป็นผู้กำกับและแสดงในภาพยนต์สั้นเรื่องนี้และเป็นผู้ตัดต่อภาพยนต์สั้นเรื่องนี้ด้วย
          </p>
          {/* วิดีโอกิจกรรม */}
          <div className="mt-12">
            ...
            <div className="rounded-lg overflow-hidden shadow-md w-full aspect-video">
              <iframe
                src="https://www.youtube.com/embed/hnD_wBB6Nr8" // ใช้ embed link
                title="วิดีโอกิจกรรม"
                frameBorder="0"
          ...
          <div className="mt-12">
            ...
            <div className="rounded-lg overflow-hidden shadow-md w-full aspect-video">
              <iframe
                src="https://www.youtube.com/embed/VYAsJiqdD9s" // ใช้ embed link
                title="วิดีโอกิจกรรม"
                frameBorder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
