    ...
    <div>
      ...
      >
        ...
        <div className="absolute inset-0">
          <Image
            src="/picture/project_sec/project_22/project_ (1).png"
            alt="Background"
            fill
      ...
      <section className="min-h-screen bg-gray-50 py-20 px-6">
        <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg p-8">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mb-4">
            ได้เริ่มทำอนิเมชั่นในวิชา Animation
          </h1>
          <p className="text-gray-600 mb-6 leading-relaxed">
            เป็นครั้งแรกที่ได้เริ่มทำอนิเมชั่นด้วย Flipacilp
          </p>
          {/* วิดีโอกิจกรรม */}
          <div className="mt-12">
            ...
            <div className="rounded-lg overflow-hidden shadow-md w-full aspect-video">
              <iframe
                src="https://www.youtube.com/embed/La6ZoFNLmtA" // ใช้ embed link
                title="วิดีโอกิจกรรม"
                frameBorder="0"
          ...
          <div className="mb-8">
            ...
            <div className="rounded-lg overflow-hidden shadow-md mb-8">
              <Image
                src="/picture/project_sec/project_22/project_ (2).png"
                alt="ภาพกิจกรรม"
                width={800}
                height={400}
